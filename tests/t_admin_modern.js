...
ok(r.d.querySelectorAll('#dashboardSection .admin-dashboard-link:not([hidden]) .card-note').length===8,'every active management shortcut includes a concise description');
