...
const reportActions=[...view.querySelectorAll('.question-report .report-actions button')];
ok(reportActions.length===4&&/In review/.test(view.textContent)&&!/Notify student|Reopen/.test(view.textContent),'report row keeps only question, review, resolve, and dismiss actions');
ok(view.querySelector('.report-question-open svg'),'specific-question action is a compact icon');
